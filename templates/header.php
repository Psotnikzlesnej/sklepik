    ...
    <div class="container">
      <div  class="menu-long">
        ...
        <div class="menu__text">
          <a href="javascript:void(0);" class="hamburger mobile__block" onclick="hamburger()">
            <svg xmlns="http://www.w3.org/2000/svg" class="menu__lo-padding" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
          ...
          <a class="menu__lo mobile__block" href="#">
            <svg class="menu__lo-padding" id="Group_4915" data-name="Group 4915" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="27.858" height="100%" viewBox="0 0 27.858 27.982">
              <defs>
          ...
          <a class="menu__lo mobile__block" href="#" >
            <svg class="menu__lo-padding" xmlns="http://www.w3.org/2000/svg" width="28.176" height="100%" viewBox="0 0 28.176 26.923">
      ...
      <div class="menu" id="hamburger__menu">
        ...
        <a class="menu__item" href="#">
          <span>OŚWIETLENIE WEWNETRZNE</span>
        </a>
        <a class="menu__item" href="#">
          <span>GNIAZDKA, WYŁĄCZNIKI</span>
        </a>
        <a class="menu__item" href="#">
          <span>AUTOMATYKA, STEROWANIE</span>
        </a>
        <a  class="menu__item" href="#">
          <span>ROZDZIELANIE I APARATURA</span>
        </a>
